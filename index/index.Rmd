...
title: 'EURYALE'
subtitle: 'Fluxos de Trabalho e Reprodutibilidade em Metagenômica'
...
No entanto, a \gls{MS} possui ainda diversas vantagens sobre a \gls{16S}, sobretudo no que diz respeito à identificação de espécies, a construção de novos genomas e a aferição de informação funcional, apesar de seu custo, tanto financeiro quanto computacional, ser superior às abordagens \gls{16S} [@tessler2017].
