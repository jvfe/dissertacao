...
% Caso não tenha substítulo, comente a linha a seguir.
  \subtitulo{Fluxos de Trabalho e Reprodutibilidade em Metagenômica}
...
\begin{fichacatalografica}
	\includepdf{papers/ficha_catalografica_101833.pdf}
...
\strut \\
Agradeço às instituições brasileiras que me possibilitaram fazer pesquisa. Agradeço à CAPES pelo fomento. Agradeço sobretudo aos inúmeros trabalhadores nessas instituições que as fazem funcionar, apesar das limitações financeiras e estruturais do Brasil.\\
\strut \\
...
No entanto, a \gls{MS} possui ainda diversas vantagens sobre a \gls{16S}, sobretudo no que diz respeito à identificação de espécies, a construção de novos genomas e a aferição de informação funcional, apesar de seu custo, tanto financeiro quanto computacional, ser superior às abordagens \gls{16S} \autocite{tessler2017}.
...
\end{figure}
Tipicamente software é tratado como um ponto adjacente à uma análise científica, e não seu principal produto. Parcialmente isto se dá devido ao modelo de desenvolvimento de software científico atualmente vigente, que se dá por meio de projetos de doutorado e mestrado, dificultando, dessa maneira, manutenção a longo prazo \autocite{altschul2013} \autocite{mangul2019a}. Portanto, produzir metodologias que sejam usáveis a longo prazo sem necessitarem de alta manutenção é essencial. Ademais, vale destacar também a importância dos princípios FAIR, que já possuem uma importância crucial no desenvolvimento de recursos computacionais, apesar de seu alcance no contexto de software científico ainda ser um tanto limitado \autocite{barker2022}. Nesse sentido, a utilização de tecnologias que facilitem a instalação de software, como gerenciadores de ambiente, ou tecnologias capazes de encapsular um ambiente computacional, como contêineres, são indispensáveis para a garantia de reprodutibilidade de qualquer método computacional, por garantirem o isolamento das dependências de um \emph{software} indefinidamente \autocite{kadri2022}.
...
\item
  Descrever seus avanços em relação ao seu precedente, no que tange os princípios de desenvolvimento de software previamente citados.
\end{itemize}
...
Ademais, ressaltamos a existência do EURYALE como um \emph{software} vivo e que continuará a ser atualizado, mediante necessidades dos seus usuários, usuários que, durante a escrita do presente documento, já apontaram a ausência de visualizações e relatórios da sua etapa funcional, limitação que será tratada em trabalhos posteriores.
